...
describe('defineState — basic behaviour', () => {
  ...
  it('state initialised in one hook, setState called from another', () => {
  ...
  it('factory defaultValue is called on initialisation', () => {
...
describe('defineState — localStorage', () => {
  it('reads value from localStorage on initialisation', () => {
...
describe('defineState — known issues', () => {
  ...
  it('[BUG] onSet stale closure — original callback is called', () => {
    ...
    expect(first).toHaveBeenCalledTimes(1) // broken behaviour
